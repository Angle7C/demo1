...
public class Question {
     ...
     *
     * @mbggenerated Tue Apr 26 20:04:40 CST 2022
     */
    private Integer id;
    ...
    public QuestionDTO getDTO(UserDTO userDTO) {
      QuestionDTO questionDTO=new QuestionDTO();
      questionDTO.setDescription(this.description);
      questionDTO.setLikeCount(this.likeCount);
      questionDTO.setViewCount(this.viewCount);
      questionDTO.setCommentCount(this.commentCount);
      questionDTO.setId(this.id);
      questionDTO.setUser(userDTO);
      questionDTO.setTitle(this.title);
      questionDTO.setTags(TagMap.changeString(this.tag));
      return questionDTO;
    };
}